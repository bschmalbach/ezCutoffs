#' @export
plot.invarianceCutoffs <- function(x, fit_indices = NULL, type = 'histogram', ...) {
  
  #OVERLAPPING HISTOGRAMS COULD BE NICE
  #NEED TO COMBINE DATA FOR ALL MODELS INTO ONE DATAFRAME
